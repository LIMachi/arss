...
public class KeyboardScreen extends SimpleScreen {
    public static void client_open(Player player, InteractionHand hand) {
        if (Minecraft.getInstance().isSameThread())
            Minecraft.getInstance().setScreen(new KeyboardScreen(player, hand));
    }
    ...
    protected KeyboardScreen(Player player, InteractionHand hand) {
